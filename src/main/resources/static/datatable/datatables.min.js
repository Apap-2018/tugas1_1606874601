 ...
 *   https://datatables.net/download/#dt/dt-1.10.11,af-2.1.1,r-2.0.2
 *
 * Included libraries:
 *   DataTables 1.10.11, AutoFill 2.1.1, Responsive 2.0.2
 */

/*!
 DataTables 1.10.11
 Ãƒâ€šÃ‚Â©2008-2015 SpryMedia Ltd - datatables.net/license
*/
...
this._iDisplayLength,b=this._iDisplayStart,c=b+a,d=this.aiDisplay.length,e=this.oFeatures,f=e.bPaginate;return e.bServerSide?!1===f||-1===a?b+d:Math.min(b+a,this._iRecordsDisplay):!f||c>d||-1===a?d:c},oInstance:null,sInstance:null,iTabIndex:0,nScrollHead:null,nScrollFoot:null,aLastSort:[],oPlugins:{},rowIdFn:null,rowId:null};m.ext=v={buttons:{},classes:{},build:"dt/dt-1.10.11,af-2.1.1,r-2.0.2",errMode:"alert",feature:[],search:[],selector:{cell:[],column:[],row:[]},internal:{},legacy:{ajax:null},pager:{},renderer:{pageButton:{},
